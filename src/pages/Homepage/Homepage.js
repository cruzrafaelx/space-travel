...
function Homepage() {
  return (
    <section className='homepage'>
        ...
        <div className='lower-homepage grid-container'>
          <div>
            <h1 className='fs-500 uppercase ff-sans-cond letter-spacing-1'>So, you want to travel to <span className='fs-900 ff-serif'>space</span></h1>
